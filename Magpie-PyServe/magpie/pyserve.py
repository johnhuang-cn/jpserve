r"""PyServer is a Python script executor running on the Python side.
...
logger = logging.getLogger('pserve')
...
class PyServe():
    ...
    def start(self):
        logger.info("Magpie magpie starting...")
        ...
        logger.info("Magpie magpie listening in %s %s " % self.server_address)  
    ...
    def shutdown(self):
        ...
        logger.info("Magpie magpie stopped.")  
